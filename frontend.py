...
class LoginWindow(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.resizable(False, False) #Hace que la ventana no sea redimensionable para mantener el diseño consistente.
    ...
    def _crear_usuarios_default(self):
        ...
        if not os.path.exists(ruta):
            with open(ruta, mode='w', newline='', encoding='utf-8') as file:
                ...
                writer.writerow(["santi@mail.com", "1234", "ciudadano"])
                writer.writerow(["carlos@mail.com", "admin", "autoridad"])
                writer.writerow(["alo@mail.com", "1234", "ciudadano"])
                writer.writerow(["lupita@mail.com", "1234", "ciudadano"])
                writer.writerow(["", "", ""]) #Fila vacía para evitar errores al leer

    def register_user(self):
        messagebox.showinfo("Registro", "Pronto podrás registrarte directamente desde la aplicación. Por ahora, utiliza las credenciales de prueba proporcionadas.")
